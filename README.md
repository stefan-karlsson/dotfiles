...
This dotfiles repository is currently aimed for [**Ubuntu on WSL**](https://ubuntu.com/wsl), [**Ubuntu Server**](https://ubuntu.com/server), and [**Ubuntu Desktop**](https://ubuntu.com/desktop), tested against versions **20.04**, **22.04**, **24.04** and **24.10**. See how to get started with WSL [here](https://docs.microsoft.com/pt-br/windows/wsl/install-win10).
...
- `DOTFILES_USER`: Defaults to `stefan-karlsson`.
...
```console
DOTFILES_BRANCH=beta sh -c "$(wget -qO- https://tinyurl.com/skarlsson)"
```
...
```bash
git clone https://github.com/stefan-karlsson/dotfiles "$HOME/.dotfiles"
...
- [`README.md`](./README.md)
  - Replace all occurrences of `https://tinyurl.com/skarlsson` with `https://raw.githubusercontent.com/<your-username>/dotfiles/HEAD/scripts/install_dotfiles.sh`
