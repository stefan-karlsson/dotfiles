...
test_setup "$@"
workspace_script="$(test_render_template 'home/.chezmoiscripts/run_always_after_22-configure-repository-workspace.sh.tmpl')"
...
rm "$fake_bin/code"
missing_code_home="${test_root}/missing-code-home"
mkdir -p "$missing_code_home"
